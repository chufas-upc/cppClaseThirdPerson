...
void AcppClaseThirdPersonCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AcppClaseThirdPersonCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AcppClaseThirdPersonCharacter::Look);
...
void AcppClaseThirdPersonCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AcppClaseThirdPersonCharacter::DoMove(float Right, float Forward)
{
...
void AcppClaseThirdPersonCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AcppClaseThirdPersonCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AcppClaseThirdPersonCharacter::DoJumpEnd()
{
